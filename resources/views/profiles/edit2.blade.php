								...
								<div class="container">
									<div class="row">
										...
										<div class="col-md-12 mb-4 mx-auto">
											...
											<!-- Nav tabs -->
											<ul class="nav md-tabs nav-justified" style="margin-bottom: -30px;">
											...
											<div class="tab-content card">
														...
														<div class="col-sm-12">
															<div id="avatar_container">
																<div class="collapseOne card-collapse collapse @if($user->profile->avatar_status == 0) show @endif">
																	<div class="card-body">
																		<img src="{{  Gravatar::get($user->email) }}" alt="{{ $user->name }}" class="user-avatar" width="150">
																	</div>
																</div>
												...
												<div class="tab-pane fade" id="panel2" role="tabpanel">
													...
													<div class="form-group margin-bottom-2">
														<div class="col-12">
															<button class="btn"> <a href="{{trans ('profile.submitProfileButton')}}" > </a> Update </button>
														</div>
													</div>
												...
												<div class="tab-pane fade" id="panel3" role="tabpanel">
													<ul class="account-admin-subnav nav nav-pills nav-justified margin-bottom-3 margin-top-1">
														...
														<li class="nav-item bg-info">
															<a data-toggle="pill" href="#deleteAccount" class="nav-link bg-danger text-white">
